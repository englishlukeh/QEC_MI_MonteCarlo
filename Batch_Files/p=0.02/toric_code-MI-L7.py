...
for values in range(num_iter):
    ...
    with open('MI-L7-S.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
    ...
    header = ["EC", "EC-Count"]
    with open('MI-L7-EC.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
    ...
    with open('MI-L7-S_EC.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
